...
class Order(Base):
    ...
    invoice_uuid: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    checkout_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    invoice_expiry_at: Mapped[DateTime | None] = mapped_column(DateTime(timezone=True), nullable=True)
